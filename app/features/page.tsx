  ...
  const sections = [
    {
      ...
      description:
        "Advanced algorithms analyze your organizational data, market patterns, and operational metrics to create comprehensive simulation environments that mirror real-world complexity.",
    },
    {
      ...
      description:
        "Our proprietary Monte Carlo tree search algorithms explore millions of potential scenarios, combining probabilistic modeling with intelligent agent behavior to map opportunity landscapes.",
    },
    {
      ...
      description:
        "Deep learning networks analyze simulation outcomes to identify high-leverage opportunities, ranking potential paths by impact, probability, and resource requirements.",
    },
    {
      ...
      description:
        "Massive multi-agent systems collaborate within simulations, each specialized for different domains, creating emergent intelligence that reveals non-obvious strategic advantages.",
    },
    {
      ...
      description:
        "Real-time simulation updates and continuous learning algorithms adapt to changing conditions, providing dynamic guidance for optimal decision-making and resource allocation.",
    },
  ]
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <div className="space-y-8">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-black leading-tight bg-white/80 backdrop-blur-sm tracking-caps">
                AGENTIC SIMULATIONS
              </h1>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed">
                Harness the power of advanced Monte Carlo tree search algorithms combined with massive agentic systems
                to simulate complex scenarios and identify high-leverage opportunities in your data.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <section key={section.id} id={section.id} className="container mx-auto max-w-6xl">
              ...
              >
                <div className={`space-y-8 ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-black bg-white/80 leading-tight tracking-caps">
                    {section.title}
                  </h2>
                  <p className="text-md text-zinc-400 leading-relaxed">{section.description}</p>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.281-.059-1.69-.073-4.949-.073zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                    </svg>
                  </Link>
